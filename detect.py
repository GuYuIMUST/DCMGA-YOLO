...
if __name__ == '__main__':
    model = YOLO(r'D:\leo\ultralytics-main26\ultralytics-main\runs\detect\runs\end330\yolo262\weights\best.pt') # select your model.pt path
    model.predict(source=r'D:\qileo\last\image',
                  imgsz=640,
                  project='runs/detect',
                  name='yolo26',
                  save=True,
