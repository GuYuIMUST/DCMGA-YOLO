...
if __name__ == '__main__':
    model_path = r'D:\leo\ultralytics-main26\ultralytics-main\runs\detect\runs\gc\yolo12.yaml\weights\best.pt'
    model = YOLO(model_path) # 选择训练好的权重路径
    result = model.val(data=r'D:\leo\GC10-DET_811\data.yaml',
